...
const ticketmasterCall = (genre) => {
    return fetch(
            `https://app.ticketmaster.com/discovery/v2/events.json?apikey=iGNHGX3JLkYElcOGNL7J2qMZl02a5nBU&city=Nashville&countryCode=US&classificationName=${genre}`
        )
        .then(concerts => concerts.json())
};

//Calls for fetch from tickemaster API, passing genre to narrow list. Console logs results.
const ticketmasterLog = (genre) => {
